...
{
  if (isset($_REQUEST['kategorikode']))
    {
        $kategorikode = $_REQUEST['kategorikode'];
    }
...
<form method="POST" enctype="multipart/form-data">
  <div class="form-group row">
    ...
    <div class="col-sm-10">
      <input type="text" class="form-control" id="kategorikode" name="kategorikode" placeholder="Kode Kategori" maxlength="4" required>
    </div>
  </div>
  ...
  <div class="form-group row">
    ...
    <div class="col-sm-10">
      <input type="text" class="form-control" name="kategorinama" id="kategorinama" placeholder="Nama Kategori" required>
    </div>
  </div>
  ...
  <div class="form-group row">
    ...
    <div class="col-sm-10">
      <textarea class="form-control" name="kategoriket" id="kategoriket" placeholder="Keterangan" required></textarea>
    </div>
  </div>
  ...
  <div class="form-group row">
    ...
    <div class="col-sm-10">
      <input type="text" class="form-control" name="kategoriref" id="kategoriref" placeholder="Referensi" required>
    </div>
  </div>
...
<td>
<a onclick="return confirm('Apakah anda yakin ingin menghapus data?')" href="kategorihapus.php?hapus=<?php echo $row["kategoriID"]?>"
