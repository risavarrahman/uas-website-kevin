...
<?php
  ...
  $editdestinasi = mysqli_query($connection, "SELECT * FROM destinasi, fotodestinasi
      WHERE fotoID = '$fotoid' and destinasi.destinasiID = fotodestinasi.destinasiID");
...
<form method="POST" enctype="multipart/form-data">
  <div class="form-group row">
    <label for="fotoid" class="col-sm-2 col-form-label">ID Photo</label>
    <div class="col-sm-10">
      <input type="text" class="form-control" id="fotoid" name="fotoid" value="<?php echo $rowedit["fotoID"]?>" readonly>
    </div>
  </div>
  ...
  <div class="form-group row">
    ...
    <div class="col-sm-10">
      <input type="text" class="form-control" id="fotokode" name="fotokode" value="<?php echo $rowedit["fotoKODE"]?>" required>
    </div>
  </div>
  ...
  <div class="form-group row">
    ...
    <div class="col-sm-10">
      <input type="text" class="form-control" id="fotonama" name="fotonama" value="<?php echo $rowedit["fotoNAMA"]?>" required>
    </div>
  </div>
  ...
  <div class="form-group row">
    ...
    <select class="form-control" id="destinasiid" name="destinasiid">
        <option value="<?php echo $rowedit["destinasiID"]?>"><?php echo $rowedit
            ['destinasiID']?> <?php echo $rowedit2['destinasiNAMA']?></option>
  ...
  <div class="form-group row">
    ...
    <div class="col-sm-10">
      ...
      <img src="/Website_Kevin/ADMIN/img/<?php echo $rowedit['fotofile']?>" style="width: 200px; height: 100px;">
