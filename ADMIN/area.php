...
if(isset($_POST['Simpan']))
{
  if (isset($_REQUEST['areakode']))
    ...
    mysqli_query($connection, "INSERT INTO area VALUES ('', '$areakode', '$areanama', '$areawilayah', '$areaket', '$provinsikode')");
...
<div class="col-sm-10">
  ...
  <form method="POST" enctype="multipart/form-data">
    <div class="form-group row">
      ...
      <div class="col-sm-10">
        <input type="text" class="form-control" id="areakode" name="areakode" placeholder="Kode Area" maxlength="4" required>
      </div>
    </div>
    ...
    <div class="form-group row">
      ...
      <div class="col-sm-10">
        <input type="text" class="form-control" name="areanama" id="areanama" placeholder="Nama Area" required>
      </div>
    </div>
    ...
    <div class="form-group row">
      ...
      <div class="col-sm-10">
        <input type="text" class="form-control" name="areawilayah" id="areawilayah" placeholder="Wilayah Area" required>
      </div>
    </div>
    ...
    <div class="form-group row">
      ...
      <div class="col-sm-10">
        <textarea class="form-control" name="areaket" id="areaket" placeholder="Keterangan" required></textarea>
      </div>
    </div>

    <div class="form-group row">
      <label for="provinsikode" class="col-sm-2 col-form-label">Provinsi</label>
    <div class="col-sm-10">
