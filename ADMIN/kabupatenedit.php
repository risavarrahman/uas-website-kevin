...
if(isset($_POST['Edit']))
{
  ...
  kabupatenALAMAT   ='$kabupatenalamat', 
  kabupatenKET      ='$kabupatenket'
...
$editkabupaten = mysqli_query($connection, "SELECT kabupaten.*, provinsi.provinsiNAMA
 FROM kabupaten, provinsi WHERE kabupatenID = '$kabupatenid'
 AND provinsi.provinsiID = kabupaten.provinsiID");
...
<form method="POST" enctype="multipart/form-data">
  <div class="form-group row">
    <label for="kodedestinasi" class="col-sm-2 col-form-label">ID Kabupaten</label>
    <div class="col-sm-10">
      <input type="text" class="form-control" id="kodedestinasi" name="inputkode" value="<?php echo $rowedit["kabupatenID"]?>" maxlength="4" disabled>
    </div>
  </div>
  ...
  <div class="form-group row">
    ...
    <div class="col-sm-10">
      <input type="text" class="form-control" name="kabupatennama" id="kabupatennama" value="<?php echo $rowedit["kabupatenNAMA"]?>">
    </div>
  </div>

  <div class="form-group row">
    <label for="kabupatenalamat" class="col-sm-2 col-form-label">Alamat</label>
    <div class="col-sm-10">
      <input type="text" class="form-control" name="kabupatenalamat" id="kabupatenalamat" value="<?php echo $rowedit["kabupatenALAMAT"]?>">
    </div>
  </div>

  <div class="form-group row">
    <label for="kabupatenket" class="col-sm-2 col-form-label">Keterangan</label>
    <div class="col-sm-10">
      <textarea class="form-control" name="kabupatenket" id="kabupatenket"><?php echo $rowedit["kabupatenKET"]?></textarea>
    </div>
  </div>
...
<div class="row">
    ...
    <table class="table table-hover table-danger">
        ...
        {
            $search = $_POST['search'];
            $query = mysqli_query($connection, "SELECT kabupaten.*, provinsi.provinsiNAMA FROM kabupaten, provinsi
