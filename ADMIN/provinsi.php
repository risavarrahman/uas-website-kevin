...
{
  if (isset($_REQUEST['provinsikode']))
    {
        $provinsikode = $_REQUEST['provinsikode'];
    }
    ...
    mysqli_query($connection, "INSERT INTO provinsi VALUES ('', '$provinsikode', '$provinsinama', '$provinsialamat', '$provinsiket')");
...
<form method="POST">
  <div class="form-group row">
    ...
    <div class="col-sm-10">
      <input type="text" class="form-control" id="provinsikode" name="provinsikode" placeholder="Kode Provinsi" maxlength="4" required>
    </div>
  </div>
  ...
  <div class="form-group row">
    ...
    <div class="col-sm-10">
      <input type="text" class="form-control" name="provinsinama" id="provinsinama" placeholder="Nama Provinsi" required>
    </div>
  </div>
  ...
  <div class="form-group row">
    ...
    <div class="col-sm-10">
      <input type="text" class="form-control" name="provinsialamat" id="provinsialamat" placeholder="Alamat Provinsi" required>
    </div>
  </div>
  ...
  <div class="form-group row">
    ...
    <div class="col-sm-10">
    <textarea class="form-control" name="provinsiket" id="provinsiket" placeholder="Keterangan" required></textarea>
    </div>
  </div>
    ...
    <table class="table table-hover table-danger">
        ...
        if(isset($_POST["kirim"]))
        {
            ...
            $query = mysqli_query($connection, "SELECT * FROM provinsi
                WHERE required provinsiNAMA like '%".$search."%'");
        }else
            {
                $query = mysqli_query($connection, "SELECT * FROM provinsi");
            }
...
<td>
<a onclick="return confirm('Apakah anda yakin ingin menghapus data?')" href="provinsihapus.php?hapus=<?php echo $row["provinsiID"]?>"
