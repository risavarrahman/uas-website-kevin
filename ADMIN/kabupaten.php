...
{
  if (isset($_REQUEST['kabupatenid']))
    {
        $kabupatenid = $_REQUEST['kabupatenid'];
    }
    ...
    mysqli_query($connection, "INSERT INTO kabupaten VALUES ('', '$provinsiid', '$kabupatennama', '$kabupatenalamat', '$kabupatenket')");
...
<form method="POST" enctype="multipart/form-data">
  ...
  <div class="form-group row">
    ...
    <div class="col-sm-10">
      <input type="text" class="form-control" name="kabupatennama" id="kabupatennama" placeholder="Nama Kabupaten">
    </div>
  </div>
  ...
  <div class="form-group row">
    ...
    <div class="col-sm-10">
      <input type="text" class="form-control" name="kabupatenalamat" id="kabupatenalamat" placeholder="Alamat Kabupaten">
    </div>
  </div>
  ...
  <div class="form-group row">
    ...
    <div class="col-sm-10">
      <textarea class="form-control" name="kabupatenket" id="kabupatenket" placeholder="Keterangan"></textarea>
    </div>
  </div>
