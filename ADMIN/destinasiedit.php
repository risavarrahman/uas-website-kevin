...
if(isset($_POST['Edit'])) {
  if (isset($_REQUEST['destinasikode'])) {
    ...
    destinasiALAMAT   ='$destinasialamat', 
    kategoriID        ='$kategoriid',
    areaID            ='$areaid'
    WHERE destinasiID ='$destinasiid'");
    header("location: destinasi.php");
}
...
$editdestinasi = mysqli_query($connection, "SELECT * FROM destinasi WHERE destinasiID = '$destinasiid'");
$rowedit = mysqli_fetch_array($editdestinasi);

$editkategori = mysqli_query($connection, "SELECT * FROM destinasi, kategori 
WHERE destinasiID = '$destinasiid' AND destinasi.kategoriID = kategori.kategoriID");
$rowedit2 = mysqli_fetch_array($editkategori);

$editarea = mysqli_query($connection, "SELECT * FROM destinasi, area WHERE destinasiID = '$destinasiid' and destinasi.areaID = area.areaID");
...
<form method="POST">
  <div class="form-group row">
    <label for="destinasiid" class="col-sm-2 col-form-label">ID</label>
    <div class="col-sm-10">
      <input type="text" class="form-control" id="destinasiid" name="destinasiid" value="<?php echo $rowedit["destinasiID"]?>" disabled maxlength="5" required>
    </div>
  </div>
  ...
  <div class="form-group row">
    ...
    <div class="col-sm-10">
      <input type="text" class="form-control" id="destinasikode" name="destinasikode" value="<?php echo $rowedit["destinasiKODE"]?>" requried>
    </div>
  </div>
  ...
  <div class="form-group row">
    ...
    <div class="col-sm-10">
      <input type="text" class="form-control" name="destinasinama" id="destinasinama" value="<?php echo $rowedit["destinasiNAMA"]?>" requried>
    </div>
  </div>
  ...
  <div class="form-group row">
    ...
    <div class="col-sm-10">
      <input type="text" class="form-control" name="destinasialamat" id="destinasialamat" value="<?php echo $rowedit["destinasiALAMAT"]?>" requried>
    </div>
  </div>
